...
// @grant        none
// @downloadURL  https://raw.githubusercontent.com/MrMugiwara/BLS-Spain-Autofill/main/bls-spain-autofill.js
...
// field "VisaTypeId" is "167" for "schengen visa".
// ### ------- Value lookup on the embassy page ------- ###
...
const passportIssueDate = "2024-06-22" // Enter the date when the passport has been issued in YEAR-MONTH-DAY (YYYY-MM-DD) (Read from your passport)
const passportExpiryDate = "2024-06-22" // Enter the date when the passport has been expired in YEAR-MONTH-DAY (YYYY-MM-DD) (Read from your passport)
